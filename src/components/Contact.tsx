              ...
              <div className="space-y-8">
                ...
                <div className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800">
                  ...
                  <div className="flex space-x-4">
                    ...
                    {/* Instagram */}
                    <a href="https://www.instagram.com/zpro.3d?igsh=ZDVibm42a3NvamFh" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gradient-to-tr from-pink-500 via-red-500 to-yellow-500 rounded-full flex items-center justify-center hover:from-pink-600 hover:via-red-600 hover:to-yellow-600 transition-colors duration-300">
                    ...
                    <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-black rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors duration-300" title="TikTok">
                      <svg className="w-6 h-6 text-white" viewBox="0 0 48 48" fill="none"><g><path d="M41.5 17.5c-3.6 0-6.5-2.9-6.5-6.5V6h-6.5v25.5c0 2.2-1.8 4-4 4s-4-1.8-4-4 1.8-4 4-4c.7 0 1.3.2 1.9.5v-6.2c-.6-.1-1.3-.2-1.9-.2-5.5 0-10 4.5-10 10s4.5 10 10 10 10-4.5 10-10V23c1.9 1.1 4.1 1.8 6.5 1.8V17.5z" fill="#fff"/></g></svg>
                    </a>
                    {/* WhatsApp */}
